...
function originaltruscottbrindley1!(du, u, p, t)
    ...
    return du[2] = Rₘ * Z * P^2 / (α^2 + P^2) - μ * Z
end
...
# """
#     origtb_rσ(r, σ)
# A shortcut command for returning a CoupledSDEs of the original Truscott-Brindley system in a default setup with multiplicative anisotropic noise.
...
# A shortcut command for returning a CoupledSDEs of the ramped original Truscott-Brindley system in a default setup with multiplicative anisotropic noise.
...
#     Σ = [1 0; 0 √γ];
#     process = "WhiteGauss";
#     CoupledSDEs(f, vcat(pf_wo_r, [v, Ttrans, Tramp]), dim, σ, g, pg, Σ, process)
# end;

...
#     Σ = [1/√ξ 0; 0 1];
#     process = "WhiteGauss";
#     CoupledSDEs(f, vcat([r], pf_wo_r), dim, σ, g, pg, Σ, process)
# end;

# """
#     modtb_αξσ(α, ξ, σ)
# A shortcut command for returning a CoupledSDEs of the modified Truscott-Brindley system in a default setup with multiplicative anisotropic noise.
...
#     Σ = [1 0; 0 1];
#     process = "WhiteGauss";
#     CoupledSDEs(f, vcat([α], pf_wo_αξ, [ξ]), u, σ, g, pg, Σ, process)
# end;
...
#     Σ = [1 0; 0 1];
#     process = "WhiteGauss";
#     CoupledSDEs(f, vcat([α], pf_wo_αξ, [ξ]), dim, σ, g, pg, Σ, process)
# end;
...
# A shortcut command for returning a CoupledSDEs of the ramped modified Truscott-Brindley system in a default setup with multiplicative anisotropic noise.
...
#     Σ = [1 0 0; 0 0 0; 0 0 0];
#     process = "WhiteGauss";
#     CoupledSDEs(f, vcat(pf_wo, [ξ, v, Ttrans, Tramp]), dim, σ, g, pg, Σ, process)
# end;

...
Stommel's hemispheric 2-box model of the Thermohaline Circulation[^Stommel 1961].
...
relaxation coefficients, the advective coefficient ``\\mu = \\frac{1}{\\lambda}``, and the constant ``\\R``
...
* `flow_law`: Relation between density difference and flow strength.
  ...
  * `"diffu_abs"`: Absolute flow law Q2 in eq. (2.4) of Cessi 1994[^Cessi 1994]
  * `"diffu_sqr"`: Absolute flow law Q3 in eq. (2.4) of Cessi 1994[^Cessi 1994]

...
- `proximity_kw`: Keywords propagated to [`AttractorsViaProximity`](https://juliadynamics.github.io/Attractors.jl/v1.36/api/#Attractors.AttractorsViaProximity), for mapping

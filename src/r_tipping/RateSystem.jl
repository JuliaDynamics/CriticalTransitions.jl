...
function p_modified(auto_sys::CoupledODEs,rc::RateConfig,t::Float64)
    ...
    pidx,p,section_start,section_end,window_start,window_end,dp = rc.pidx,rc.p,rc.section_start,rc.section_end,rc.window_start,rc.window_end,rc.dp
